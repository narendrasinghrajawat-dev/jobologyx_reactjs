...
const STAT_CARDS = [
  { key: "total", label: "Applications", icon: FileText, color: "text-primary-600 bg-primary-50 dark:bg-primary-900/30 dark:text-primary-400" },
  { key: "reviewing", label: "Reviewing", icon: Clock, color: "text-warning-600 bg-warning-50 dark:bg-warning-500/10 dark:text-warning-500" },
  { key: "shortlisted", label: "Shortlisted", icon: Star, color: "text-success-600 bg-success-50 dark:bg-success-500/10 dark:text-success-500" },
  { key: "rejected", label: "Rejected", icon: XCircle, color: "text-error-600 bg-error-50 dark:bg-error-500/10 dark:text-error-500" },
];
              ...
              >
                <div className="min-w-0">
                  ...
                  <p className="truncate text-xs text-slate-500 dark:text-slate-400">
                    {app.job?.companyName} · Applied {formatDate(app.createdAt)}
                  </p>
                </div>
